namespace BuildWatcher
{
    ...
    /// </summary>
    public class LastTwoBuildResults
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LastTwoBuildResults"/> class. 
        ...
        public LastTwoBuildResults(IBuildDefinition buildDefinition, IBuildDetail lastBuild, IBuildDetail previousBuild)
        {
